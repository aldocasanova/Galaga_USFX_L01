...
{	
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> ShipMesh(TEXT("StaticMesh'/Game/TwinStick/Meshes/NaveGodines.NaveGodines'"));
...
{
	bCanMove = false;
	GetWorldTimerManager().SetTimer(TimerHandle_Hielo, this, &AGalaga_USFX_L01Pawn::EnableMovement, 2.0f, false); // 2 segundos
}
