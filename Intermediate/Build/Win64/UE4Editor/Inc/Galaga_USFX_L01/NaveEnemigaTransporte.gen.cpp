...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANaveEnemigaTransporte_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ANaveEnemigaTransporte_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UNaveEnemigaObserver_NoRegister, (int32)VTABLE_OFFSET(ANaveEnemigaTransporte, INaveEnemigaObserver), false },
		};
	...
	IMPLEMENT_CLASS(ANaveEnemigaTransporte, 2605861221);
